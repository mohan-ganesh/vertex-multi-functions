...
public class AutomaticFunctionCalling {
    ...
    // This is just a stub and can be substituted with any external functions with
    // http calls.
    ...
    // Use the Automatic Function Calling feature to auto-respond to model's
    ...
    public static String automaticFunctionCalling(
        ...
        try (VertexAI vertexAI = new VertexAI(projectId, location)) {
            ...
            FunctionDeclaration functionDeclaration = FunctionDeclarationMaker.fromFunc(
            ...
            GenerativeModel model = new GenerativeModel(modelName, vertexAI).withTools(Arrays.asList(tool));
